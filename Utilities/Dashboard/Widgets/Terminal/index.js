export function mount(el, context){
  const css = `
    ...
    .screen { flex:1 1 auto; min-height:160px; background:#0b0f16; color:#e6e8ef; border:1px solid #222835; border-radius:8px; padding:8px; overflow:auto; font-family: ui-monospace, SFMono-Regular, Menlo, monospace; font-size: 12px; white-space: pre-wrap; word-break: break-word; }
