export function mount(el, context) {
  const tpl = `
    ...
    <div class="content" style="gap:8px;">
      ...
      <pre id="debugOut" style="height:260px; overflow:auto; background:#0f141d; border:1px solid #222835; border-radius:8px; padding:8px; white-space:pre-wrap;">(capturing logs...)</pre>
    </div>
