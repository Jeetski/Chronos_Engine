...
- Day Builder: `docs/guides/day_builder.md` - scheduling-first day composition, template lifecycle, validation, and apply-to-today flow.
- Routine Builder: `docs/guides/routine_builder.md` - routine/subroutine/microroutine template composition with drag/drop schedulables, hierarchy editing, and validation.
