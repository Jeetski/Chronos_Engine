...
## Overview
Time-focused utility widget combining clock context with quick operational actions.
Widgets should keep UI actions aligned with canonical CLI/API behavior and avoid hidden side effects.

## CLI
- Related command patterns: `listener start; new alarm <name>; new reminder <name>; today`.
...
## Dashboard
- Runtime source: `utilities/dashboard/widgets/clock/`
