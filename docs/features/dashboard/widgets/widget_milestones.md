...
## Overview
Milestone list/update widget for progression checkpoints.
Widgets should keep UI actions aligned with canonical CLI/API behavior and avoid hidden side effects.

## CLI
- Related command patterns: `list milestones; view milestone <name>; update milestone status`.
...
## Dashboard
- Runtime source: `utilities/dashboard/widgets/Milestones/`
