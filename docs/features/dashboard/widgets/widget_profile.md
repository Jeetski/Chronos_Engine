...
## Overview
Pilot profile and avatar management widget with achievement summary context.
Widgets should keep UI actions aligned with canonical CLI/API behavior and avoid hidden side effects.

## CLI
- Related command patterns: `profile; settings profile fields; avatar update workflows`.
...
## Dashboard
- Runtime source: `utilities/dashboard/widgets/profile/`
