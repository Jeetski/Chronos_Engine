...
## Overview
Recent log and debugging signal viewer for runtime diagnosis.
Widgets should keep UI actions aligned with canonical CLI/API behavior and avoid hidden side effects.

## CLI
- Related command patterns: `N/A (observability surface)`.
...
## Dashboard
- Runtime source: `utilities/dashboard/widgets/debug_console/`
