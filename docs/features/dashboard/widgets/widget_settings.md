...
## Overview
Settings file browser/editor for YAML-backed Chronos settings.
Widgets should keep UI actions aligned with canonical CLI/API behavior and avoid hidden side effects.

## CLI
- Related command patterns: `settings <file_shortcut> <key> <value>`.
...
## Dashboard
- Runtime source: `utilities/Dashboard/Widgets/Settings/`
