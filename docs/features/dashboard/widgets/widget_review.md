...
## Overview
Review period workflow widget using review data endpoints and command execution.
Widgets should keep UI actions aligned with canonical CLI/API behavior and avoid hidden side effects.

## CLI
- Related command patterns: `review day/week/month; sequence trends`.
...
## Dashboard
- Runtime source: `Utilities/Dashboard/Widgets/Review/`
