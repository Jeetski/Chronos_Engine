...
## Overview
Commitment status, evaluation, and override workflow surface.
Widgets should keep UI actions aligned with canonical CLI/API behavior and avoid hidden side effects.

## CLI
- Related command patterns: `commitments check; list commitments; view commitment <name>`.
...
## Dashboard
- Runtime source: `utilities/dashboard/widgets/commitments/`
