...
## Overview
Points/reward balance and redemption operations.
Widgets should keep UI actions aligned with canonical CLI/API behavior and avoid hidden side effects.

## CLI
- Related command patterns: `points balance; list rewards; redeem reward <name>`.
...
## Dashboard
- Runtime source: `Utilities/Dashboard/Widgets/Rewards/`
