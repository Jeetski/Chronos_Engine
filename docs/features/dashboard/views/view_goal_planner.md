...
## Overview
Goal-centered planning workspace for inspecting and updating goal structures.

## CLI
- Related command patterns: `new goal <name>; track goal <name>; view goal <name>`.
...
## Dashboard
- Runtime source: `utilities/dashboard/views/goal_planner/`
...
## Validation
1. Open `GoalPlanner` view from dashboard navigation.
