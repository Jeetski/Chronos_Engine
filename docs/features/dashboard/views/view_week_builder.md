...
## Overview
Week-level planning composition surface for multi-day structure editing.

## CLI
- Related command patterns: `template list type:week; template view week <name>`.
...
## Validation
1. Open `WeekBuilder` view from dashboard navigation.
