# TemplateBuilder View

## Overview
General template construction workspace across multiple schedulable/template types.

## CLI
- Related command patterns: `template list; template view <type> <name>; template apply ...`.
...
## Dashboard
- Runtime source: `utilities/dashboard/views/template_builder/`
...
## Validation
1. Open `TemplateBuilder` view from dashboard navigation.
