...
## Overview
In-app documentation explorer with tree browsing, search, and file reading.

## CLI
- Related command patterns: `docs; help; search docs via CLI tools when applicable`.
...
## Validation
1. Open `Docs` view from dashboard navigation.
