...
## Overview
Time-series progress view for source-based yearly tracking.

## CLI
- Related command patterns: `track <type> <name>; review week; review month`.
...
## Validation
1. Open `Tracker` view from dashboard navigation.
