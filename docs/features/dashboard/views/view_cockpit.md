...
## Overview
Mission-control view that hosts panel compositions for daily operational dashboards.

## CLI
- Related command patterns: `dashboard; sequence sync matrix; status`.
...
## Dashboard
- Runtime source: `utilities/dashboard/Views/Cockpit/`
...
## Validation
1. Open `Cockpit` view from dashboard navigation.
