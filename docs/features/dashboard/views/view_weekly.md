...
## Overview
Weekly summary and plan surface for seven-day review/planning loops.

## CLI
- Related command patterns: `review week; this <weekday>; next <weekday>`.
...
## Validation
1. Open `Weekly` view from dashboard navigation.
