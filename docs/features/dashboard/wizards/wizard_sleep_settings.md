# SleepSettings Wizard

## Overview
Guided sleep setup flow that creates/updates sleep-related items/settings.
Wizards should produce deterministic item/settings outcomes that remain editable through normal CLI and dashboard tools.

## CLI
- Related command patterns: `new sleep-related items; template updates for anchors/routines`.
...
## Dashboard
- Runtime source: `utilities/dashboard/wizards/sleep_settings/`
...
## Validation
1. Open `SleepSettings` from dashboard wizard registry/menu.
