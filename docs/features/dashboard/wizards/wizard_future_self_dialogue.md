# FutureSelfDialogue Wizard

## Overview
Reflective writing wizard for guided dialogue and future-self prompts.
Wizards should produce deterministic item/settings outcomes that remain editable through normal CLI and dashboard tools.

## CLI
- Related command patterns: `new journal_entry <name>; append journal_entry <name>`.
...
## Validation
1. Open `FutureSelfDialogue` from dashboard wizard registry/menu.
