...
def _read_core_tables() -> Dict[str, List[sqlite3.Row]]:
...
def _prepare_activity_facts(schedules: List[sqlite3.Row], completions: List[sqlite3.Row]) -> List[Dict[str, Any]]:
