...
:: Minimal launcher (Gemini CLI-based). Uses gemini -p for prompts.
set "PORT=8080"
...
:: Use Gemini CLI instead of Codex
set "ADUC_CLI_BACKEND=gemini"
:: Infinite Gemini timeout for large prompts (0 or unset = infinite)
set "ADUC_GEMINI_TIMEOUT=0"
