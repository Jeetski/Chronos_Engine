...
## Overview
Achievement tracking and progression management surface.
Widgets should keep UI actions aligned with canonical CLI/API behavior and avoid hidden side effects.

## CLI
- Related command patterns: `achievements sync; achievements event; achievements award; view achievement <name>`.
